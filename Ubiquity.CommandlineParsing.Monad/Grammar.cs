...
namespace Ubiquity.CommandlineParsing.Monad
{
    ...
    // in order of dependencies, otherwise additional "ref" monads are needed, which add overhead.
    ...
    public static class Grammar
    {
        ...
        public static Parser<CommandlineOption> OptionParser( Parser<IEnumerable<char>> leadingParser, Parser<IEnumerable<char>> valueSep )
        {
            return from leading in leadingParser.Text( )
                   ...
                   let option = optionalValue.GetOrElse<(string sep, CommandlineValue value)>( (( string )( default ), ( CommandlineValue )( default )) )
                   let sep = option.sep
